...
UNION
SELECT name,email,gender FROM admin_users;

SELECT name,email,gender,date_of_birth,'user' as role FROM users
UNION
SELECT name,email,gender,date_of_birth,'admin' as role FROM admin_users
