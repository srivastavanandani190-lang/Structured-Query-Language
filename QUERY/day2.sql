...
SELECT * FROM users;
SELECT * FROM users WHERE gender<>'Male'; -- not equal i.e female
...
SELECT * FROM users WHERE gender='Female' OR salary>'70000' ORDER BY date_of_birth ASC; -- DESC

-- update is used to modify existing records in a table. 
-- The SET clause specifies the column(s) to be updated and their new values.
